...
weight: 73
url: /bg/javascript-net/showcases/how-to-use-aspose-cad-in-javascript/
---
...
1. Изберете файл.<br>
![Изберете файл](/cad/_assets/javascript-net/javascript-net/choose-file.png)<br>
...
![Конвертиране на изображение](/cad/_assets/javascript-net/javascript-net/convert-image.png)<br>
## Вижте също
