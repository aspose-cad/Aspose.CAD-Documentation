...
![Създаване на проект azure function](/_assets/java/java-azure/create-function-ide-1.png)<br>
![Създаване на проект azure function-крайно](/_assets/java/java-azure/create-function-ide-2.png)<br>
...
![Вход в Azure](/_assets/java/java-azure/add-docker-support.png)<br>
...
![Стартиране на docker в ide](/_assets/java/java-azure/docker-run-in-ide.png)<br>
1. Въведете името на изображението, както в хранилището Docker HUb.<br>
![Стартиране на docker в ide-следващ](/_assets/java/java-azure/docker-run-in-ide-1.png)<br>
...
![Бутон Създаване на функция Azure](/_assets/java/java-azure/create-function-azure.png)<br>
1. Повторете основните настройки, както на изображението по-долу.<br>
![Настройки за създаване на функция Azure](/_assets/java/java-azure/create-function-settings.png)<br>
1. Щракнете на 'Преглед + създаване' -> Създаване.
1. Изчакайте да завърши внедряването.
1. Щракнете на бутона 'Отидете на ресурса'.<br>
![Бутон Ресурс](/_assets/java/java-azure/go-to-resource.png)<br>
1. Спиране на функцията aspose-cad-docker-example.<br>
![Спиране на контейнера](/_assets/java/java-azure/stop-container.png)<br>
1. Отидете в менюто на центъра за внедряване и направете необходимите настройки.<br>
![Център за внедряване](/_assets/java/java-azure/deployment-center.png)<br>
...
![Настройки на Webhook в docker](/_assets/java/java-azure/webhook.png)<br>
1. Щракнете бутона създаване.
1. Върнете се в прегледа на azure функцията и стартирайте контейнера.<br>
![Меню Преглед](/_assets/java/java-azure/overview.png)<br>
{{% alert color="primary" %}} 
...
![Меню Преглед](/_assets/java/java-azure/postman-settings.png)<br>
...
![Запазване на отговор](/_assets/java/java-azure/response-postman.png)<br>
