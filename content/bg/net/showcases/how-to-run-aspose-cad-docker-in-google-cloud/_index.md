...
![Създаване на Artifact Repository](create-artifact-repository.png)<br>
1. Изберете новото репозиторио в Artifact Registry.
![Изберете репозиторио за артефакти](select-artifact.png)<br>
...
![Обзорно меню](postman-settings.png)<br>
