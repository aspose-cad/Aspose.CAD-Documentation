...
type: docs
weight: 20
url: /pl/jasperreports/installation/integration-with-jasperserver/
---
{{% alert color="primary" %}}
Aby zintegrować Aspose.CAD dla JasperReports z JasperServer, konieczne jest podjęcie kilku dodatkowych kroków oraz zaktualizowanie plików konfiguracyjnych JasperServer. Artykuł ten wyjaśnia jak to zrobić.
{{% /alert %}}
...
{{< highlight xml >}}
    ...
    <bean id="jpgASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="JPG - Eksport obrazu z Aspose.CAD"/>
    ...
    <bean id="bmpASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="BMP - Eksport obrazu z Aspose.CAD"/>
    ...
    <bean id="gifASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="GIF - Eksport obrazu z Aspose.CAD"/>
    ...
    <bean id="jpg2000ASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="JPG2000 - Eksport obrazu z Aspose.CAD"/>
    ...
    <bean id="pdfASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PDF - Eksport obrazu z Aspose.CAD"/>
    ...
    <bean id="pngASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PNG - Eksport obrazu z Aspose.CAD"/>
    ...
    <bean id="psdASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PSD - Eksport obrazu z Aspose.CAD"/>
    ...
    <bean id="svgASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="SVG - Eksport obrazu z Aspose.CAD"/>
    ...
    <bean id="tiffASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="TIFF - Eksport obrazu z Aspose.CAD"/>
    ...
    <bean id="wmfASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="WMF - Eksport obrazu z Aspose.CAD"/>
...
{{< /highlight >}}
    ...
    Aby zmienić tryb eksportu, użyj właściwości o nazwie "exportMode" i ustaw wartość zgodnie z pożądanym trybem. 
Na przykład:
{{< highlight xml >}}
    <property name="exportMode">
        <value type="com.aspose.cad.jasperreports.common.ExportMode">SinglePage</value>
...
{{< /highlight >}}
    Możesz zmienić wartość właściwości na Batch, SinglePage lub Multipage używając typu enum com.aspose.cad.jasperreports.common.ExportMode.

2. Znajdź element <util:map id="exporterConfigMap">...</util:map> w pliku %INTALL_DIR%\\apache-tomcat\webapps\jasperserver\WEB-INF\flows\viewReportBeans.xml i dodaj poniższe linie:
{{< highlight xml >}}
    <util:map id="exporterConfigMap">
        <!-- skomentuj/odkomentuj dowolną z linii poniżej, jeśli chcesz, aby odpowiedni eksporter 
        	 został wykluczony/włączony na liście eksporterów przeglądarki
        	 Uwaga: oddzielna konfiguracja dla iPada 'exportersSupportedByiPad'
        	 -->
        ...
        -->
			...
			<!-- dodaj te wpisy do exporterConfigMap -->
		...
		<!-- Aspose.CAD dla JasperReports KONIEC -->
    </util:map>
{{< /highlight >}}
3. Skopiuj aspose-cad-jasperreports-xx.xx.jar do %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\lib.
4. Aby używać funkcji eksportu, zaktualizuj %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\applicationContext.xml jak poniżej.
{{< highlight xml >}}
    <bean id="jpgExportParameters" class="com.aspose.cad.jasperreports.jpg.ASJpegExportParametersBean">
	<!--        Odkomentuj i zmodyfikuj, aby zastosować licencję. Sprawdź ścieżkę do licencji.
...
5. Uruchom ponownie serwer JasperReports i otwórz dowolny raport, aby wyświetlić. Jeśli poprzednie kroki zostały poprawnie wykonane, zobaczysz dodatkowe opcje na liście formatów eksportu.
