...
type: docs
weight: 80
url: /jasperreports/user-guide/export-jasperreport-to-jpeg2000/
---

{{% alert color="primary" %}}

Aspose.CAD for JasperReports provides a class named ASJpeg2000Exporter for exporting JasperReport to JPEG2000.
