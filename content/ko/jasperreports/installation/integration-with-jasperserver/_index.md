...
type: docs
weight: 20
url: /ko/jasperreports/installation/integration-with-jasperserver/
---
{{% alert color="primary" %}}
Aspose.CAD를 JasperReports와 JasperServer 통합하려면 몇 가지 추가 단계를 수행하고 JasperServer 구성 파일을 업데이트해야 합니다. 이 문서에서는 그 방법을 설명합니다.
{{% /alert %}}
1. %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\flows\viewReportBeans.xml 구성 파일에 새로운 내보내기 속성을 추가합니다.
{{< highlight xml >}}
    <!--JPG-->
    ...
    <bean id="jpgASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="JPG - Aspose.CAD에서 이미지 내보내기"/>
    ...
    <bean id="bmpASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="BMP - Aspose.CAD에서 이미지 내보내기"/>
    ...
    <bean id="gifASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="GIF - Aspose.CAD에서 이미지 내보내기"/>
    ...
    <bean id="jpg2000ASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="JPG2000 - Aspose.CAD에서 이미지 내보내기"/>
    ...
    <bean id="pdfASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PDF - Aspose.CAD에서 이미지 내보내기"/>
    ...
    <bean id="pngASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PNG - Aspose.CAD에서 이미지 내보내기"/>
    ...
    <bean id="psdASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PSD - Aspose.CAD에서 이미지 내보내기"/>
    ...
    <bean id="svgASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="SVG - Aspose.CAD에서 이미지 내보내기"/>
    ...
    <bean id="tiffASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="TIFF - Aspose.CAD에서 이미지 내보내기"/>
    ...
    <bean id="wmfASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="WMF - Aspose.CAD에서 이미지 내보내기"/>
...
{{< /highlight >}}
    ...
    내보내기 모드를 변경하려면 "exportMode"라는 이름의 속성을 사용하고 원하는 모드에 따라 값을 넣으십시오. 
예를 들어:
{{< highlight xml >}}
    <property name="exportMode">
        <value type="com.aspose.cad.jasperreports.common.ExportMode">SinglePage</value>
...
{{< /highlight >}}
    속성의 값을 Batch, SinglePage 또는 Multipage로 변경할 수 있습니다. com.aspose.cad.jasperreports.common.ExportMode 열거형을 사용하십시오.

2. %INTALL_DIR%\\apache-tomcat\webapps\jasperserver\WEB-INF\flows\viewReportBeans.xml 파일에서 <util:map id="exporterConfigMap">...</util:map> 요소를 찾고 다음 줄을 추가합니다:
{{< highlight xml >}}
    <util:map id="exporterConfigMap">
        <!-- 관련 내보내기를 제외/포함시키려면 아래 줄의 주석을 해제/해제하세요
        	 주의: iPad에 대한 별도의 구성 'exportersSupportedByiPad'
        	 -->
        ...
        -->
			...
			<!-- 이 항목을 exporterConfigMap에 추가하세요 -->
			<!-- Aspose.CAD JasperReports 시작 -->
		...
		<!-- Aspose.CAD for JasperReports 끝 -->
    </util:map>
{{< /highlight >}}
3. aspose-cad-jasperreports-xx.xx.jar 파일을 %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\lib에 복사합니다.
4. 내보내기 기능을 사용하려면 %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\applicationContext.xml을 아래와 같이 업데이트합니다.
{{< highlight xml >}}
    <bean id="jpgExportParameters" class="com.aspose.cad.jasperreports.jpg.ASJpegExportParametersBean">
	<!--        라이센스를 적용하려면 주석을 해제하고 수정하세요. 라이센스 경로를 확인하세요.
...
5. JasperReports Server를 재시작하고 어떤 보고서든 열어보세요. 이전 단계가 제대로 수행되었다면, 내보내기 형식 목록에 추가 옵션이 표시될 것입니다.
![todo:image_alt_text](/cad/_assets/jasper/ExportReportView.png)

추가 형식(아이콘 또는 선택)이 보이지 않으면 \apache-tomcat\logs 디렉토리의 로그 파일을 확인하십시오.
