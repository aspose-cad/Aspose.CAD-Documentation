...
type: docs
weight: 20
url: /id/jasperreports/installation/integration-with-jasperserver/
---
{{% alert color="primary" %}}
Untuk mengintegrasikan Aspose.CAD untuk JasperReports dengan JasperServer, perlu melakukan beberapa langkah tambahan dan memperbarui file konfigurasi JasperServer. Artikel ini menjelaskan caranya.
{{% /alert %}}
1. Tambahkan properti eksportir baru ke file konfigurasi %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\flows\viewReportBeans.xml.
{{< highlight xml >}}
    <!--JPG-->
    ...
    <bean id="jpgASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="JPG - Ekspor gambar dari Aspose.CAD"/>
    ...
    <bean id="bmpASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="BMP - Ekspor gambar dari Aspose.CAD"/>
    ...
    <bean id="gifASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="GIF - Ekspor gambar dari Aspose.CAD"/>
    ...
    <bean id="jpg2000ASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="JPG2000 - Ekspor gambar dari Aspose.CAD"/>
    ...
    <bean id="pdfASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PDF - Ekspor gambar dari Aspose.CAD"/>
    ...
    <bean id="pngASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PNG - Ekspor gambar dari Aspose.CAD"/>
    ...
    <bean id="psdASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PSD - Ekspor gambar dari Aspose.CAD"/>
    ...
    <bean id="svgASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="SVG - Ekspor gambar dari Aspose.CAD"/>
    ...
    <bean id="tiffASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="TIFF - Ekspor gambar dari Aspose.CAD"/>
    ...
    <bean id="wmfASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="WMF - Ekspor gambar dari Aspose.CAD"/>
...
{{< /highlight >}}
    ...
    Untuk mengubah mode ekspor, gunakan properti dengan nama "exportMode" dan masukkan nilai sesuai dengan mode yang diinginkan. 
Sebagai contoh:
{{< highlight xml >}}
    <property name="exportMode">
        <value type="com.aspose.cad.jasperreports.common.ExportMode">SinglePage</value>
...
{{< /highlight >}}
    Anda dapat mengubah nilai properti menjadi Batch, SinglePage, atau Multipage menggunakan jenis enum com.aspose.cad.jasperreports.common.ExportMode.

2. Temukan elemen <util:map id="exporterConfigMap">...</util:map> di file %INTALL_DIR%\\apache-tomcat\webapps\jasperserver\WEB-INF\flows\viewReportBeans.xml dan tambahkan baris berikut:
{{< highlight xml >}}
    <util:map id="exporterConfigMap">
        <!-- komentar/hapus komentar untuk salah satu baris di bawah jika Anda ingin eksportir terkait
        	 dikecualikan/ditambahkan dalam daftar eksportir viewer
        	 Catatan: konfigurasi terpisah untuk iPad 'exportersSupportedByiPad'
        	 -->
        ...
        -->
			...
			<!-- Aspose.CAD JasperReports MULAI -->
		...
		<!-- Aspose.CAD untuk JasperReports SELESAI -->
    </util:map>
{{< /highlight >}}
3. Salin aspose-cad-jasperreports-xx.xx.jar ke %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\lib.
4. Untuk menggunakan fitur ekspor, perbarui %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\applicationContext.xml seperti di bawah ini.
{{< highlight xml >}}
    <bean id="jpgExportParameters" class="com.aspose.cad.jasperreports.jpg.ASJpegExportParametersBean">
	<!--        Hapus komentar dan modifikasi untuk menerapkan lisensi. Periksa jalur lisensi.
