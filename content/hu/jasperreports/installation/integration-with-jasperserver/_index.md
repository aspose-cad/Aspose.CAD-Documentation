---
title: Integráció a JasperServer-rel
type: docs
weight: 20
url: /hu/jasperreports/installation/integration-with-jasperserver/
---
{{% alert color="primary" %}}
Az Aspose.CAD integrálása a JasperReports-hoz a JasperServer-rel több további lépést igényel, valamint frissíteni kell a JasperServer konfigurációs fájlokat. Ez a cikk elmagyarázza, hogyan.
{{% /alert %}}
1. Új exportőr tulajdonságokat kell hozzáadni a %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\flows\viewReportBeans.xml konfigurációs fájlhoz.
{{< highlight xml >}}
    <!--JPG-->
    ...
    <bean id="jpgASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="JPG - Kép exportálás az Aspose.CAD-ból"/>
    ...
    <bean id="bmpASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="BMP - Kép exportálás az Aspose.CAD-ból"/>
    ...
    <bean id="gifASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="GIF - Kép exportálás az Aspose.CAD-ból"/>
    ...
    <bean id="jpg2000ASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="JPG2000 - Kép exportálás az Aspose.CAD-ból"/>
    ...
    <bean id="pdfASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PDF - Kép exportálás az Aspose.CAD-ból"/>
    ...
    <bean id="pngASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PNG - Kép exportálás az Aspose.CAD-ból"/>
    ...
    <bean id="psdASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PSD - Kép exportálás az Aspose.CAD-ból"/>
    ...
    <bean id="svgASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="SVG - Kép exportálás az Aspose.CAD-ból"/>
    ...
    <bean id="tiffASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="TIFF - Kép exportálás az Aspose.CAD-ból"/>
    ...
    <bean id="wmfASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="WMF - Kép exportálás az Aspose.CAD-ból"/>
...
{{< /highlight >}}
    ...
    Az exportálási mód megváltoztatásához használja az "exportMode" nevű tulajdonságot, és állítsa be az értéket a kívánt mód szerint.
Például:
{{< highlight xml >}}
    <property name="exportMode">
        <value type="com.aspose.cad.jasperreports.common.ExportMode">SinglePage</value>
...
{{< /highlight >}}
A tulajdonság értékét Batch-ra, SinglePage-re vagy Multipage-ra változtathatja a com.aspose.cad.jasperreports.common.ExportMode enum típus használatával.

2. Keresse meg a <util:map id="exporterConfigMap">...</util:map> elemet a %INTALL_DIR%\\apache-tomcat\webapps\jasperserver\WEB-INF\flows\viewReportBeans.xml fájlban, és adja hozzá a következő sorokat:
{{< highlight xml >}}
    <util:map id="exporterConfigMap">
        <!-- kommentálja ki/bontsательно ha bármelyik sor szeretné, hogy a kapcsolódó exportőrök 
        	 ki legyenek zárva/belépve a néző exportőreinek listájába
        	 Megjegyzés: külön konfiguráció az iPad számára 'exportersSupportedByiPad'
        	 -->
        ...
        -->
			...
			<!-- adja hozzá ezt a belépőt az exporterConfigMap-hez -->
			<!-- Aspose.CAD JasperReports KEZDŐDIK -->
		...
		<!-- Aspose.CAD a JasperReports-hoz VÉGZŐDIK -->
    </util:map>
{{< /highlight >}}
3. Másolja az aspose-cad-jasperreports-xx.xx.jar fájlt a %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\lib mappába.
4. Az exportálási funkciók használatához frissítse a %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\applicationContext.xml fájlt az alábbiak szerint.
{{< highlight xml >}}
    <bean id="jpgExportParameters" class="com.aspose.cad.jasperreports.jpg.ASJpegExportParametersBean">
	<!--        Kommentálja ki és módosítsa, hogy licencet érvényesítsen. Ellenőrizze a licenccel kapcsolatos útvonalat.
