---
title: 与JasperServer的集成
type: docs
weight: 20
url: /zh/jasperreports/installation/integration-with-jasperserver/
---
{{% alert color="primary" %}}
要将Aspose.CAD for JasperReports集成到JasperServer中，需要采取几个额外步骤并更新JasperServer配置文件。本文将说明如何操作。
{{% /alert %}}
1. 将新的导出器属性添加到 %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\flows\viewReportBeans.xml 配置文件中。
{{< highlight xml >}}
    <!--JPG-->
    ...
    <bean id="jpgASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="JPG - 来自Aspose.CAD的图像导出"/>
    ...
    <bean id="bmpASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="BMP - 来自Aspose.CAD的图像导出"/>
    ...
    <bean id="gifASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="GIF - 来自Aspose.CAD的图像导出"/>
    ...
    <bean id="jpg2000ASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="JPG2000 - 来自Aspose.CAD的图像导出"/>
    ...
    <bean id="pdfASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PDF - 来自Aspose.CAD的图像导出"/>
    ...
    <bean id="pngASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PNG - 来自Aspose.CAD的图像导出"/>
    ...
    <bean id="psdASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="PSD - 来自Aspose.CAD的图像导出"/>
    ...
    <bean id="svgASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="SVG - 来自Aspose.CAD的图像导出"/>
    ...
    <bean id="tiffASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="TIFF - 来自Aspose.CAD的图像导出"/>
    ...
    <bean id="wmfASExporterParameters" class="com.jaspersoft.jasperserver.war.action.ExporterConfigurationBean">
        <property name="descriptionKey" value="WMF - 来自Aspose.CAD的图像导出"/>
...
{{< /highlight >}}
    ...
    要更改导出的模式，请使用名为 "exportMode" 的属性，并根据所需的模式输入值。 
例如：
{{< highlight xml >}}
    <property name="exportMode">
        <value type="com.aspose.cad.jasperreports.common.ExportMode">SinglePage</value>
...
{{< /highlight >}}
    您可以使用 com.aspose.cad.jasperreports.common.ExportMode 枚举类型将属性值更改为 Batch、SinglePage 或 Multipage。

2. 在 %INTALL_DIR%\\apache-tomcat\webapps\jasperserver\WEB-INF\flows\viewReportBeans.xml 文件中找到 <util:map id="exporterConfigMap">...</util:map> 元素，并添加以下行：
{{< highlight xml >}}
    <util:map id="exporterConfigMap">
        <!-- 如果您希望相关的导出器排除/包含在查看器的导出器列表中，请注释/取消注释以下任何行
        	 注意：为iPad单独配置 'exportersSupportedByiPad'
        	 -->
		...
		<!-- Aspose.CAD for JasperReports 结束 -->
    </util:map>
{{< /highlight >}}
3. 将 aspose-cad-jasperreports-xx.xx.jar 复制到 %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\lib。
4. 要使用导出功能，请按如下所示更新 %INTALL_DIR%\apache-tomcat\webapps\jasperserver\WEB-INF\applicationContext.xml。
{{< highlight xml >}}
    <bean id="jpgExportParameters" class="com.aspose.cad.jasperreports.jpg.ASJpegExportParametersBean">
	<!--        取消注释并修改以应用许可证。检查许可证路径。
