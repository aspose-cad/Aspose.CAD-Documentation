...
---
{{% alert color="primary" %}}
To integrate Aspose.CAD for JasperReports with JasperServer, it is necessary to take several additional steps and update the JasperServer config files. This article explains how.
{{% /alert %}}
